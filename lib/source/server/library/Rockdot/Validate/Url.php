...
+---------------------------------------------------------------------------------------+ 
 *
 * @desc extends Rockdot_Validate_Abstract for concrete implementation
 ...
 * @import: Rockdot_Validate_Abstract	 
 */
require_once('Rockdot/Validate/Exception.php');
require_once('Rockdot/Validate/Abstract.php');
	
class Rockdot_Validate_Url extends Rockdot_Validate_Abstract{	
	/*	+-----------------------------------------------------------------------------------+
	| 	class-member-vars
	+-----------------------------------------------------------------------------------+  */	
	/**
	...
	*/
	public function __construct($allowInternational = false, $allowInternal = false, array $_allowedSchemes = array('http', 'https')){
		if(!is_bool($allowInternational)){
			throw new Rockdot_Validate_Exception('allowInternational must be type of string');	
		}
		$this->allowInternational = $allowInternational;
		if(!is_bool($allowInternal)){
			throw new Rockdot_Validate_Exception('allowInternal must be type of string');	
		}
	...
	/**
	* @desc 
	* abstract inherited method defined in Rockdot_Validate_Abstract must be overridden
