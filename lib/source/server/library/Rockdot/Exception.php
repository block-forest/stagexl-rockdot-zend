 ...
 * @import: 
 */
abstract class Rockdot_Exception extends Exception{
/*  +-----------------------------------------------------------------------------------+
	| 	class member-vars
	+-----------------------------------------------------------------------------------+  */
   	/**
...
/*	+-----------------------------------------------------------------------------------+
	...
	* @access public from all scopes
	*/
	public static function setErrorHandler($callback = array('Rockdot_Exception', 'phpWarningsToException')){
