...
+---------------------------------------------------------------------------------------+ 
 *
 * @desc extends Rockdot_Filter_Abstract for concrete implementation
 ...
 *
 * @dependencies
 * @import: Rockdot_Exception
 * @import: Rockdot_Filter_Abstract	 
 */
require_once('Rockdot/Filter/Exception.php');
require_once('Rockdot/Filter/Abstract.php');
	
class Rockdot_Filter_ObjectToArray extends Rockdot_Filter_Abstract{	
/*	+-----------------------------------------------------------------------------------+
	| 	class-member-vars
	+-----------------------------------------------------------------------------------+  */
	/**
	...
	*/
	public function setIgnoreVisibility($ignoreVisibility){
		if(!is_bool($ignoreVisibility)){
			throw new Rockdot_Filter_Exception('ignoreVisibility must be type of boolean', 1001);	
		}
	...
	/**
	* @desc 
	* abstract inherited method defined in Rockdot_Filter_Abstract must be overridden
