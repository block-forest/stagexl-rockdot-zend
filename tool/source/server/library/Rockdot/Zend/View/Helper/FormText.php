...
+---------------------------------------------------------------------------------------+ 
 *
 * @desc Rockdot_Zend_View_Helper_FormText extends Zend_View_Helper_FormText
 ...
 * @package________Rockdot_Zend_View_Helper       
 *
 * @dependencies
...
class Rockdot_Zend_View_Helper_FormText extends Zend_View_Helper_FormText{
	/**
